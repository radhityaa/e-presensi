...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        ...
        <table class="table">
            <tr>
                <td>NIK :</td>
                <td style="text-align: start">{{ $student->nik }}</td>
            </tr>
            <tr>
                <td>Nama Lengkap :</td>
                <td style="text-align: start">{{ $student->name }}</td>
            </tr>
            <tr>
                <td>Kelas :</td>
                <td style="text-align: start">{{ $student->Classroom->name }}</td>
            </tr>
            <tr>
                <td>Nomor HP :</td>
                <td style="text-align: start">{{ $student->phone }}</td>
            </tr>
            <tr>
                <td>Alamat :</td>
                <td style="text-align: start">{{ $student->address }}</td>
            </tr>
        </table>
        ...
        <table class="table-presensi">
            ...
            @foreach ($presensis as $item)
                <tr>
                    ...
                    <td style="text-align: start;">{{ date('d-m-Y', strtotime($item->created_at)) }}</td>
                    <td style="text-align: start;">{{ $item->student->nik }}</td>
        ...
        <table style="width: 100%; margin-top: 100px;">
            <tr>
                <td colspan="6" style="text-align: right;">Purwakarta, {{ date('d-m-Y') }}</td>
            </tr>
            <tr>
